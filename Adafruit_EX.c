...
void drawArrow(int x, int y, unsigned char lane) {
    switch (lane) {
        case 0:
            drawLeft(x, y, MAGENTA);
            break;
        case 1:
            drawDown(x, y, BLUE);
            break;
        ...
        case 3:
            ...
            break;
        default:
            // Invalid lane: do nothing or handle error
            break;
    }
}
...
int drawDown(int x0, int y0, unsigned int color){
...
void drawUp(int x0, int y0, unsigned int color){
...
void drawLeft(int x0, int y0, unsigned int color){
...
void drawRight(int x0, int y0, unsigned int color){
